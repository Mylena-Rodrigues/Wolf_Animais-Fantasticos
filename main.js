...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initWorking)\n/* harmony export */ });\nfunction initWorking() {}\nvar working = document.querySelector('[data-semana]');\nvar weekDays = working.dataset.semana.split(',').map(Number); // Utilizar o map(Number) em um array de string retorna automaticamente um array de int\n\nvar times = working.dataset.horario.split(',').map(Number);\nvar nowDate = new Date();\nvar now = {\n  weekDay: nowDate.getDay(),\n  time: nowDate.getHours()\n};\nvar isOpenDay = weekDays.indexOf(now.weekDay) !== -1;\nvar isOpenHour = now.time >= times[0] && now.time < times[1];\n\nif (isOpenDay && isOpenHour) {\n  working.classList.add('open');\n}\n\n//# sourceURL=webpack://animais-fantasticos/./js/modules/working.js?");
